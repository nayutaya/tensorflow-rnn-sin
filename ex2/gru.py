...
with tf.Graph().as_default():
    ...
    istate_ph     = tf.placeholder(tf.float32, [None, num_of_hidden_nodes * 1], name="istate") # 1セルあたり1つの値を必要とする。
    ...
    with tf.name_scope("inference") as scope:
        ...
        cell = rnn_cell.GRUCell(num_of_hidden_nodes)
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(num_of_training_epochs):
            ...
            train_dict = {
                ...
                istate_ph:     np.zeros((size_of_mini_batch, num_of_hidden_nodes * 1)),
            }
        ...
        outputs = np.empty(0)
        states  = np.zeros((num_of_hidden_nodes * 1)),
